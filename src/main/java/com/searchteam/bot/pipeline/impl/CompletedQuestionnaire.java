...
public class CompletedQuestionnaire extends AbstractTelegramBotPipeline {
    ...
    public void enterPipeline(User user) {
        ...
        buttonList.add(createButtonWithCallback(ACCOUNT, "Посмотреть аккаунт"));
        buttonList.add(createButtonWithCallback(PROJECT_CHOICE, "Выбрать проект"));
    ...
    public PipelineEnum getPipelineEnum() {
        return PipelineEnum.COMPLETED_QUESTIONNAIRE;
    }
}
